...
public class scrollleg extends ModelBase {
	...
	public scrollleg() {
		...
		hexadecagon.setRotationPoint(0.0F, 24.0F, 0.0F);
		hexadecagon.cubeList.add(new ModelBox(hexadecagon, 1, 15, -8.0F, -13.8863F, 2.4896F, 16, 1, 5, 0.0F, false));
		hexadecagon.cubeList.add(new ModelBox(hexadecagon, 34, 40, -8.0F, -15.9F, 4.5033F, 16, 5, 1, 0.0F, false));

		leg = new ModelRenderer(this);
		leg.setRotationPoint(0.0F, 0.0F, 0.0F);
		hexadecagon.addChild(leg);
		leg.cubeList.add(new ModelBox(leg, 0, 0, -1.0F, -13.0F, 4.0F, 0, 0, 0, 0.0F, false));

		cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(-4.3163F, -23.8687F, 0.0F);
		...
		cube_r2.setRotationPoint(0.6837F, -19.5687F, 2.0F);
		...
		cube_r3.setRotationPoint(0.6837F, -19.5687F, 2.0F);
		...
		hexadecagon_r1.setRotationPoint(-4.0F, -14.0F, 5.0F);
		...
		hexadecagon_r2.setRotationPoint(-4.0F, -14.0F, 5.0F);
		...
		hexadecagon_r3.setRotationPoint(-4.0F, -14.0F, 5.0F);
		...
		hexadecagon_r4.setRotationPoint(-4.0F, -14.0F, 5.0F);
		...
		hexadecagon2.setRotationPoint(1.0F, -17.2F, -1.5F);
